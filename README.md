...
AI Ticket Agent is a full-stack internal support ticketing application with AI-driven ticket clarification and routing.

The project includes:
- a FastAPI backend for authentication, ticket lifecycle, feedback, and AI integration
- a React + Vite frontend for ticket submission, ticket history, dashboards, admin feedback review, and voice-assisted flows
...
- submit ticket descriptions to the AI chat endpoint
- receive AI clarification questions when a ticket is incomplete
...
Main UI areas:
- AI Companion ticket submission
- Ticket History
